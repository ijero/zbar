...
final class CameraConfigurationManager {
    ...
    private static Point getCameraResolution(Camera.Parameters parameters, Point screenResolution) {
        Point cameraResolution =
            findBestPreviewSizeValue(parameters, screenResolution, false);
    ...
    private static Point findBestPreviewSizeValue(Camera.Parameters var0, Point var1, boolean var2) {
        Point var3 = null;
        int var4 = 2147483647;
        Iterator var5 = var0.getSupportedPreviewSizes().iterator();

        while(var5.hasNext()) {
            Camera.Size var7 = (Camera.Size)var5.next();
            int var8 = var7.height * var7.width;
            if(var8 >= 76800 && var8 <= 384000) {
                int var9;
                if(var2) {
                    var9 = var7.height;
                } else {
                ...
                int var11 = Math.abs(var10 * var1.x - var9 * var1.y);
                if(var11 == 0) {
                    var3 = new Point(var9, var10);
                    break;
                }
        ...
        if(var3 == null) {
            Camera.Size var6 = var0.getPreviewSize();
            var3 = new Point(var6.width, var6.height);
        }
